      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}>
            ...
            <label className="form-check-label" htmlFor="flexSwitchCheckChecked">Enable Dark Modes</label>
          </div>
        </div>
      </div>
    </nav>
...
Navbar.defaultProps = {
  title: "Title taak re",
  aboutText: "About text pan taak",
  contact: "Contact rahila takaycha",
  donate: "donate section pn bakie"
}